...
function displayFood(foodList, title, subtitle) {
    ...
    const foodSubtitle =
        document.getElementById("food-subtitle");
...
function showUPIOption() {
    ...
    const upiError =
        document.getElementById("upi-error");
...
function openFriendshipGroup() {
    ...
    if (!friendshipModal) {
        ...
        alert(
            "Friendship Group modal is missing."
        );
...
function addPersonInput() {
    ...
    if (currentInputs.length >= 8) {
        ...
        alert(
            "A group can have up to 8 people."
        );
...
function createGroup() {
    ...
    if (people.length < 2) {
        ...
        alert(
            "Please enter at least 2 people."
        );
    ...
    friendshipGroup.number =
        groupName;


    friendshipGroup.people =
        people;
...
function showPersonSelection() {
    ...
    friendshipGroup.people.forEach(
        function(person) {
    ...
    modal.innerHTML = `
        ...
        <div class="modal">
            ...
            <h2>
                Group: ${friendshipGroup.number}
            </h2>


            <p>
                Select a person to add their food.
            </p>
...
function placeGroupOrder() {
    ...
    if (!hasFood) {
        ...
        alert(
            "Please add food for at least one person."
        );
